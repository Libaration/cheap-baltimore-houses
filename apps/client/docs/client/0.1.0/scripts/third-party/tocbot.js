...
(function (root, factory) {
  ...
  var supports =
    !!root && !!root.document && !!root.document.querySelector && !!root.addEventListener; // Feature test
  ...
  tocbot.init = function (customOptions) {
    ...
    this._scrollListener = throttle(function (e) {
      ...
      var isTop =
        e && e.target && e.target.scrollingElement && e.target.scrollingElement.scrollTop === 0;
