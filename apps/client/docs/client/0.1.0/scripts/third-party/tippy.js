!(function (t, e) {
  ...
  function L() {
    T.isTouch ||
      ((T.isTouch = !0), window.performance && document.addEventListener("mousemove", D));
  }
  function D() {
  ...
  function M(t, e) {
    var n = Object.assign(
      ...
      e.ignoreAttributes
        ? {}
        : (function (t, e) {
            return (e ? Object.keys(j(Object.assign({}, R, { plugins: e }))) : P).reduce(function (
              e,
              n
            ) {
    ...
    return (
      ...
      (n.aria = {
        ...
        content:
          "auto" === n.aria.content ? (e.interactive ? null : "describedby") : n.aria.content,
      }),
      n
    );
  }
          ...
          ((e = (function (t, e) {
            ...
            return {
              popperOptions: Object.assign({}, t.popperOptions, {
                modifiers: [].concat(
                  ((null == (n = t.popperOptions) ? void 0 : n.modifiers) || []).filter(function (
                    t
                  ) {
