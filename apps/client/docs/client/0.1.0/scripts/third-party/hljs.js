    ...
    static _walk(n, e) {
      return (
        "string" == typeof e
          ? n.addText(e)
          : e.children &&
            (n.openNode(e), e.children.forEach((e) => this._walk(n, e)), n.closeNode(e)),
        n
      );
    }
    static _collapse(e) {
  ...
  m = (function (a) {
    ...
    function B(r, s, o, e) {
      ...
      function u(e, n) {
        e.scope && "string" == typeof e.scope && E.openNode(p.classNameAliases[e.scope] || e.scope),
          e.beginScope &&
            (e.beginScope._wrap
              ? (E.addKeyword(v, p.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
                (v = ""))
      ...
      function g(e) {
        ...
        return (
          a.skip
            ? (v += t)
            : (a.excludeBegin && (v += t), d(), a.returnBegin || a.excludeBegin || (v = t)),
          u(a, e),
      ...
      function n(e, n) {
        ...
        if ("illegal" === n.type && !o) {
          const i = new Error(
            'Illegal lexeme "' + t + '" for mode "' + (m.scope || "<unnamed>") + '"'
          );
          throw ((i.mode = m), i);
        }
        if ("end" === n.type) {
    ...
    function n(e) {
      ...
      o(i) ||
        ...
        n.secondBest &&
          (e.secondBest = { language: n.secondBest.language, relevance: n.secondBest.relevance }));
    }
    let t = !1;
    function e() {
      ...
      Object.assign(a, {
        ...
        registerLanguage: function (n, e) {
          ...
          try {
            ...
            if ((j("Language definition for '{}' could not be registered.".replace("{}", n)), !S))
              throw e;
            j(e), (t = s);
          }
          t.name || (t.name = n),
        ...
        contains: [
          {
            ...
            contains: [
              ...
              i,
              {
                ...
                contains: [
                  { className: "meta", begin: /<![a-z]/, end: />/, contains: [a, i, s, r] },
                ],
              },
            ],
          },
