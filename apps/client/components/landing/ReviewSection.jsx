        ...
        <div className="container px-5 pb-20 mx-auto">
          <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
            ...
            <p className="leading-relaxed text-lg">
              Just wanted to take a few moments to thank you for the very professional way you
              assisted me in the sale of my property. Living out-of-state, I was particularly
              grateful for your quick responses & creative suggestions to resolve the challenges
